...
Exploratory data visualization allows us to get an idea of the data, before starting any modeling. Usually scatter plot is a good choice to visualize data with numerical features which allows us to see relationships/ patterns within the data.
...
ggplot(titanic, 
  ...
  ggtitle("Age by Passenger Class, Separated by Survival")
...
ggplot(data = titanic,
  ...
  ggtitle("Fare of Passenger by Embarked Town, Divided by Class")
...
but with various methods to separate coincident points such that each point is visible. Also,
beeswarm introduces additional features unavailable in stripchart, such as the ability to control
the color and plotting character of each point.
...
ggplot(titanic, aes(class, age, col = alive)) + geom_beeswarm()
...
plt.figure(figsize=(10, 6))
sns.swarmplot(x='class', y='age', data=titanic, hue='alive', palette='viridis')
plt.title("Age by Passenger Class, Separated by Survival")
