...
normalized_history_data_frame = json_normalize(history_api_json)
...
repositories_data_frame = json_normalize(json_of_github_graphql['data']['search'], record_path='edges')
