...
sprintf('number of column: %d',ncol(inner_joined))
sprintf('number of column: %d',nrow(inner_joined))
...
sprintf('number of column: %d',ncol(left_joined))
sprintf('number of column: %d',nrow(left_joined))
...
sprintf('number of column: %d',ncol(right_joined))
sprintf('number of column: %d',nrow(right_joined))
...
sprintf('number of column: %d',ncol(outer_joined))
sprintf('number of column: %d',nrow(outer_joined))
